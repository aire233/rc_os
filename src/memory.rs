...
//         // convert the frame to a virtual address
...
//                 // the page is a huge page, which means that the next entries do not point to
//                 // frames but to the next level page table
//                 panic!("Huge pages are not supported");
//             },
//         };
//     }
//
